...
Case.create(title: "The Kid is Not My Son", summary: "Billie Jean is not my lover.... she took my soul and said that I was the one. But...", status: "active", active_start: Time.now)
...
Case.create(title: "You are not a supermodel", summary: "Pabico thinks he's so sexy, but not so much says I.  Like seriously. ", active_start: Time.now)
...
Case.create(title: "Active test case Example 1", summary: "This is a test", status: "active",active_start: Time.now)
