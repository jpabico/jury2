...
Case.create(title: "Transformers are better than G.I. Joe", summary: "Transformers are so awesome.  After all, they do have Optimus Prime and Megatron.  So much better than G.I. Joe", status: "active", active_start: Time.now, active_end: Time.now + countdown_time2)
...
Case.create(title: "The dude says GIT too much in this Git tutorial video", summary: "Puns are funny but he should use them sparingly.  Like GIT real.  It's GITTING hot in here!", status: "active", active_start: Time.now, active_end: Time.now + countdown_time3)
...
Case.create(title: "Pair programming is the best!", summary: "Pair programming is an agile software development technique in which two programmers work together at one workstation. The driver writes code while the navigator talks a lot.  Two programmers switch roles frequently.", status: "active", active_start: Time.now, active_end: Time.now + countdown_time4)
...
Case.create(title: "J-POP is better than K-POP.  I challenge u.", summary: "J-POP is so much better than K-POP.  What do you think?", status: "active", active_start: Time.now, active_end: Time.now + countdown_time5)
