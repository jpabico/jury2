...
Case.create(title: "The Kid is Not My Son", summary: "Billie Jean is not my lover.... she took my soul and said that I was the one. But...", status: "active", active_start: Time.now, active_end: Time.now + countdown_time)
...
Comment.create(body:"Just reminding everyone that MJ is amazing", user_id:1,case_id:1)
Comment.create(body:"No he is not", user_id:2,case_id:1)
Comment.create(body:"Yes he is", user_id:1,case_id:1)
Comment.create(body:"Oh come on guys.  The real question is whether he is black or white", user_id:3,case_id:1)
...
# basher v. papajons
Case.create(title: "You are NOT a supermodel", summary: "Pabico thinks he's so sexy, but not so much says I.  Like seriously.", status: "active", active_start: Time.now, active_end: Time.now + countdown_time)
...
Case.create(title: "Transformers are better than G.I. Joe", summary: "Transformers are so awesome.  After all, they do have Optimus Prime and Megatron.  So much better than G.I. Joe", status: "active", active_start: Time.now, active_end: Time.now + countdown_time)
...
Case.create(title: "The dude says GIT too much in this Git tutorial video", summary: "Puns are funny but he should use them sparingly.  Like GIT real.  It's GITTING hot in here!", status: "active", active_start: Time.now, active_end: Time.now + countdown_time)
...
Case.create(title: "Pair programming is the best!", summary: "Pair programming is an agile software development technique in which two programmers work together at one workstation. The driver writes code while the navigator talks a lot.  Two programmers switch roles frequently.", status: "active", active_start: Time.now, active_end: Time.now + countdown_time)
...
Case.create(title: "J-POP is better than K-POP.  I challenge u.", summary: "J-POP is so much better than K-POP.  What do you think?", status: "active", active_start: Time.now, active_end: Time.now + countdown_time)
